...
#############################################################################################
#LABELS
login_label = Label(root, text="ISSUE BOOK", bg='black', fg="gold", font=("Courier",20,'bold'))
...
################################################################################
#BUTTONS
issue=Button(root,text="ISSUE",bg='black',fg='gold', font=('Courier',15,'bold'),activebackground="gold",activeforeground="black",command=issuebk)
issue.place(x=200,y=340)
def menupage():
    root.destroy()
    import menu1
